...
enum {
  ...
  aux_sym__body_list_repeat1 = 171,
...
static const char * const ts_symbol_names[] = {
  ...
  [aux_sym__body_list_repeat1] = "_body_list_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym__body_list_repeat1] = aux_sym__body_list_repeat1,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [542] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__body_list_repeat1, 2),
  [544] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__body_list_repeat1, 2), SHIFT_REPEAT(32),
  ...
  [551] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__body_list, 2),
  [553] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [555] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_field, 2),
  [557] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__body_list, 1),
