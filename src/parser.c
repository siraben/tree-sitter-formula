...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_trans_body_repeat1, 2), SHIFT_REPEAT(122),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_trans_body_repeat1, 2), SHIFT_REPEAT(97),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_trans_body_repeat1, 2), SHIFT_REPEAT(97),
  ...
  [105] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dom_sentences_repeat1, 2), SHIFT_REPEAT(122),
  [108] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_dom_sentences_repeat1, 2), SHIFT_REPEAT(97),
  [111] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dom_sentences_repeat1, 2), SHIFT_REPEAT(97),
  ...
  [151] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_model_body_repeat1, 2), SHIFT_REPEAT(122),
  [154] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_model_body_repeat1, 2), SHIFT_REPEAT(97),
  [157] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_model_body_repeat1, 2), SHIFT_REPEAT(97),
  ...
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(226),
  [217] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(384),
  ...
  [358] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dom_sentence, 3),
  [360] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dom_sentence, 3),
  ...
  [427] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_machine_body_repeat1, 2), SHIFT_REPEAT(139),
  [430] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_machine_body_repeat1, 2), SHIFT_REPEAT(136),
  [433] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_machine_body_repeat1, 2), SHIFT_REPEAT(242),
  [436] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_machine_body_repeat1, 2), SHIFT_REPEAT(142),
  [439] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [441] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constraint, 2),
  ...
  [451] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_domain_sig, 3, .production_id = 1),
  [453] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unop, 1),
  [455] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unop, 1),
  [457] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constraint, 3),
  [459] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constraint, 4),
  [461] = {.entry = {.count = 1, .reusable = false}}, SHIFT(132),
  [463] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binop, 1),
  [465] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binop, 1),
  [467] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [469] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod_ref_rename, 3, .production_id = 2),
  [471] = {.entry = {.count = 1, .reusable = true}}, SHIFT(308),
  [473] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod_ref_no_rename, 1),
  ...
  [963] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card_spec, 1),
