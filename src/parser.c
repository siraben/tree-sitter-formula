...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [601] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fields, 2),
  [603] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [605] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__fields_repeat1, 2),
  [607] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__fields_repeat1, 2), SHIFT_REPEAT(116),
  ...
  [630] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__fields, 1),
